...
class TestCalcTax(unittest.TestCase):
	...
	def test_calc_tax_with_incorrect_amount_type_should_raise_type_error(self):
		self.assertRaises(TypeError, calc_tax, 'ten', 0.23)

	def test_calc_tax_with_incorrect_tax_rate_type_should_raise_type_error(self):
	...
	def test_calc_tax_with_negative_amount_should_raise_error(self):
